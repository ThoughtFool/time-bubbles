...
let gameArrays = {
    ...
    enterLevel: function () {
        ...
        console.log(this.currentHordeArr);
        this.updateHistory();
        gameArrays.deployed = this.currentHordeArr.length;
    ...
    bubbleBlower: function () {
        console.log("bubbleBlower");
        console.log(gameArrays.count);

        if (parseInt(gameArrays.count) < parseInt(gameArrays.deployed)) {
            ...
            let dx = gameArrays.randomDirection(-5, 5);
            let dy = gameArrays.randomDirection(-5, 5);
            ...
            let bubbleObject = new gameArrays.bubbleBuilder(left, top, size / 2, dx, dy, bubbleID, 0.7, 10);
    ...
    startLevel: function () {
        // this.enterLevel();
        this.gameLoop = window.setInterval(this.bubbleBlower, 1000);
    },
    bubbleBuilder: function (xPos, yPos, radius, dx, dy, id, e, mass) {
        this.xPos = xPos;
        this.yPos = yPos;
        this.radius = radius;
...
startBtn.addEventListener("click", startGameLevel);
const bubbleArray = [];

// testing event loop:
function startGameLevel() {

    gameArrays.enterLevel();
